...
function applyTheme(theme) {
    ...
    if (splashLogo) {
        splashLogo.src = chosen === 'light' || chosen === 'creme' ? 'STYL Icon Glass.png' : 'STYL Logo Glass Dark.png';
    }
}
...
function exportLabel() {
    ...
    canvas.toBlob((blob) => {
        ...
        a.download = `image_${date}_at_${time}.png`;
        a.click();
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (splashLogo) {
        ...
        splashLogo.src = theme === 'light' || theme === 'creme' ? 'STYL Icon Glass.png' : 'STYL Logo Glass Dark.png';
    }
    startCamera();
    renderGallery();
